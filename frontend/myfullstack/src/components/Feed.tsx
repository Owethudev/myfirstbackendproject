...
const POST_TAGS = ["React", "TypeScript", "Framer Motion", "Tailwind"];

export function Feed({ posts, user, onDeletePost }: FeedProps) {
  // I keep post presentation and post-specific actions together so the shell only coordinates feed data.
  return (
    <motion.section
      id="feed"
